...
<template>
    ...
    <div class="about">
        <h3 class="text-3xl font-bold mt-5 dark:text-white">Maestro de Usuarios</h3>
        
        <div class="border border-gray-200 rounded-lg p-5 mt-4 dark:border-gray-700">
          
<table ref="searchTable">
    <thead>
        <tr>
            <th>
